...
class Application(Tk):
    ...
    def field(self):
        ...
        self.b3 = Button(self, text = 'Configure', height = 1, width = 5, command =  self.config)
        self.b3.place(relx = .60, rely = .70, anchor = "c")
    ...
    def config(self):
        ...
        var = StringVar(self)
        var.set('3x3') # initial value

        self.option = OptionMenu(self.top, var, '3x3', '4x4', '5x5')
        #self.option.place(relx = .50, rely = .30, anchor = "c")
        self.option.pack()

        self.topButton = Button(self.top, text="Submit", command = self.submit)
        self.topButton.pack()
    ...
    def graphs(self):
        ...
        self.neural.pack()
        self.graphButton = Button(self.top2, text="Show!")
